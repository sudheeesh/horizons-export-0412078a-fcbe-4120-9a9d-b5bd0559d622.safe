      ...
      >
        <nav className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div className="text-xl md:text-2xl font-bold gold-gradient">
              {getHeaderText()}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            {isLoggedIn ? (
              <>
                ...
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="text-gray-300 hover:bg-white/10 hover:text-[#c89b3c]"
                >
              ...
              <>
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-semibold px-4 py-2 rounded-md"
                >
                  {t("signup")}
                </Button>
              </>
            ...
            <Button
              ...
              variant="outline"
              className="glass-effect border-[#c89b3c] text-white hover:bg-[#c89b3c]/20"
            >
